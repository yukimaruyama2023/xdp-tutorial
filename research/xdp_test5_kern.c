...
/* static void *memcpy(void *dst,const void *src, size_t len){while(len--)*(char *)dst++=*(char *)src++; return NULL;} */
...
/* void load_string(char *str, void *next_point, void *data_end) { */
/*     size_t length = strlen(str); */
/*     if (next_point + length <= data_end) { */
/*         /1* pr_info("In load_string: %p\n", memcpy); *1/ */
/*         memcpy(next_point, str, 5); */
/*     /1* if (next_point + sizeof(unsigned char) <= data_end) { *1/ */
/*     /1* *(unsigned char *)next_point = 0xff; *1/ */
/*     } */
/* } */
...
int xdp_icmp_echo_func(struct xdp_md *ctx)
{
    ...
    /* const char *cpu = "cpumetrics"; */
    /* int data_length = strlen(cpu); */
    /* if (next_point + data_length > data_end) goto out; */
    /* /1* pr_info("In xdp_echo_fund: %p\n", memcpy); *1/ */
    /* memcpy(next_point, cpu, data_length); */
    /* next_point += data_length; */

    /* load_string("cpumetrics", next_point, data_end); */
    /* next_point += 1; */ 
    for (int i = 0; i < 10; i++) {

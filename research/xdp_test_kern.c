...
int xdp_icmp_echo_func(struct xdp_md *ctx)
{
    ...
    /* Add metrics to packet */
    long *icmp_payload = (long *)nh.pos;
    *icmp_payload = cpu_metrics;

    /* Add 'abc' to packet to check where the payload is seen by tcpdump*/
    /*
    char *icmp_payload = (char *)nh.pos;
    *icmp_payload = "abc";
    */
